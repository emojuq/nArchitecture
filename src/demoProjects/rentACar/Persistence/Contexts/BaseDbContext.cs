    ...
    public class BaseDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Brand>(a =>
            {
                ...
                a.HasMany(p=>p.Models); //brand'in bir sürü modeli var anlamına gelir Örnek; Bmw=>3.20,7.40
            ...
            modelBuilder.Entity<Model>(a =>
            {
                ...
                a.HasOne(p => p.Brand); //modelin bir tane brand'i var anlamına gelir Örnek;3.20 => Bmw
